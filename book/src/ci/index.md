...
* gitlab: uses GitLab CI/CD (experimental - requires additional configuration)
...
## GitLab CI Support (Experimental)

GitLab CI support is available but experimental. The basic infrastructure is in place, including:
